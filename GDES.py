...
# 使用argparse处理命令行参数
parser = argparse.ArgumentParser(description='GDES model')
...
parser.add_argument('--embedding_path_qwen', type=str, default='dynamic_link_prediction_through_GDES/dataset/embedding_feature_qwen.npy', help='text features embedded by the qwen model')
parser.add_argument('--embedding_path_bert', type=str, default='dynamic_link_prediction_through_GDES/dataset/embedding_feature_bert.npy', help='text features embedded by the qwen model')
parser.add_argument('--adj17_path', type=str, default='dynamic_link_prediction_through_GDES/adjacency_matrix/clean_adj17.csv', help='path to adjacency matrix file')
parser.add_argument('--a15_path', type=str, default='dynamic_link_prediction_through_GDES/adjacency_matrix/a15.csv', help='path to adjacency matrix file')
parser.add_argument('--industry_path', type=str, default='dynamic_link_prediction_through_GDES/dataset/industry_matrix.pkl', help='path to industry_matrix file')
parser.add_argument('--node_index', type=str, default='dynamic_link_prediction_through_GDES/adjacency_matrix/node_index.json', help='path to node_index.json file')
...
parser.add_argument('--location_path_qwen', type=str, default='dynamic_link_prediction_through_GDES/dataset/embedding_distance_qwen.npy', help='path to qwen_location file')
parser.add_argument('--location_path_bert', type=str, default='dynamic_link_prediction_through_GDES/dataset/embedding_distance_bert.npy', help='path to bert_location file')
...
class GDES(torch.nn.Module):
    def __init__(self, in_channels, args):
        super(GDES, self).__init__()
...
if __name__ == '__main__':
    ...
    model = GDES(in_channels=data.x.shape[1], args=args).to(device=args.device)
